Letters = function() {
    ...
    this.active = null;
    this.letters = [];
    this.alphabet = ["a", "A", "b", "B", "c", "C", "d","D","e","E","f","F","g","G","h","H","i","I","j","J","k","K","l","L","m","M","n","N","o","O","p","P","q","Q","r","R","s","S","t","T","u","U","v","V","w","W","x","X","y","Y","z","Z","~","&","|","^","ç","@","]","[","{","}","ù","*","µ","¤","$","£","€","°",")","(","+","-","/","<",">","²","`","é","è","1","2","3","4","5","6","7","8","9","0"
    ];
  ...
  var word = [ "AFRICAN.", "MODERNISM.", "FIELD.", "TRIANGULAR.", "ROOFS.", "FOREST.", "BAKED.", "STONE.", "BIGGER.", "DUSTY.", "STREETS.", "GUTTERS.", "HYMN.", "PRISM." ];
  var nextWord = 1;
